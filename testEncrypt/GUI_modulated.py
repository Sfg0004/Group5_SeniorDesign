...
"""
fernet = Fernet(base64.urlsafe_b64encode(secrets.token_bytes(32)))
...
def setKey(encryptionKey):
    global fernet
    fernet = Fernet(base64.urlsafe_b64encode(encryptionKey))
...
#***************************************************************************
    ...
    newFilePath = f"{newFileName[1:]}/processingFiles/{name}"
